...
3.17 Click on Continue button
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        myAccountsPage.clickOnMyAccountLink();
        myAccountsPage.selectMyAccountOptions("Register");
        myAccountsPage.enterFirstName("Devani");
        myAccountsPage.enterLastName("Carli");
        myAccountsPage.enterEmailId("devC123" + getAlphaNumericString(3) + "@gmail.com");
        myAccountsPage.enterPhoneNumber("1234567890");
        myAccountsPage.enterPassword("Devc123");
        myAccountsPage.enterConfirmPassword("Devc123");
